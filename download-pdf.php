...
$stmt = $pdo->prepare("SELECT p.*, t.layout_type, t.accent_color, t.name AS tpl_name FROM portfolios p JOIN templates t ON t.id = p.template_id WHERE p.id = ? AND p.user_id = ?");
